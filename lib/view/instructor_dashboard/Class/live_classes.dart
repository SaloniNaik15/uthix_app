  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Colors.white,
        // Instead of a simple arrow icon, use the logo image as the back button.
        leading: InkWell(
          onTap: () {
      ...
      body: Center(
        child: Container(
          height: 300, // Increased height to accommodate image and text
          width: 340,
          ...
          child: Column(
            ...
            children: [
              // Robot image centered inside the container.
              Image.asset(
                "assets/Uthix_robot.png", // Ensure this asset exists in your project
                height: 100,
              ),
